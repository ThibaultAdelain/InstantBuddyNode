  ...
  return (
    <div className='containerFooter'>
        <footer className="p-4 rounded-lg shadow md:flex md:items-center md:justify-between md:p-6 dark:bg-gray-800">
            <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">Website made by Thibault Adelain
            </span>
            <ul className="flex flex-wrap items-center text-sm text-gray-500 dark:text-gray-400 sm:mt-0">
                ...
                <li>
                    <a href="https://github.com/ThibaultAdelain" className="hover:underline">Contact</a>
                </li>
            </ul>
        </footer>
    </div>
